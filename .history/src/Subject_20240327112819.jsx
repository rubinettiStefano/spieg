...
export default const  Subject = (props)=> /* props -> {name:"Java",min:1,max:10} */
{
    ...
    return(
        <div className="p-4">
            ...
            <button className="btn btn-primary" onClick={()=>setGrade(grade-1)}>-</button>
